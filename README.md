...
This should all be relatively simply to set up, given that all the required files are included. Detailed steps for set up and launching the JupyterLab are below. 
...
```
4) [OPTIONAL] Customize the environment files to include packages of your preference. **Read the section on docker images for more information on this step.** 
...
## Find an issue? 
The repository author is a self-taught programmer; some of the language here may be imperfect. While I've done my best, I don't have an in-depth understanding of docker. Sorry! Please open an [issue](https://github.com/nicolejkeeney/docker/issues) in GitHub, shoot me an email, or [open a PR](https://github.com/nicolejkeeney/geo-py-docker/pulls) to fix any issues if you are inclined to do so (which would be much appreciated!). 
